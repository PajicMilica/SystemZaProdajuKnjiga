...
public class Porudzbina extends AbstractDomainObject implements Serializable {
    ...
    public String koloneZaInsert() {
        return " (DatumVreme, DatumIsporuke, Grad, Adresa, Cena, Popust, KonacnaCena, KupacID, AdministratorID) ";
    }
    ...
    public String vrednostiZaInsert() {
        return "'" + new Timestamp(datumVreme.getTime()) + "', '" 
                ...
                + "'" + grad + "', '" + adresa + "', " + cena + ", " + popust + ", " + konacnaCena
    ...
    public String vrednostiZaUpdate() {
        return " DatumIsporuke = '" + new java.sql.Date(datumIsporuke.getTime()) 
                + "', Grad = '" + grad + "', Adresa = '" + adresa + "', Cena = " + cena + ", "
                + "Popust = " + popust + ", KonacnaCena = " + konacnaCena;
    }
