...
public class TableModelPorudzbine extends AbstractTableModel implements Runnable {
    ...
    private String[] kolone = {"ID", "Ime i prezime kupca", "Datum isporuke", "Grad", "Adresa", "Konacna cena"};
    ...
    public Object getValueAt(int row, int column) {
        ...
        switch (column) {
            ...
            case 1: return p.getKupac().getImeKupca() + " " + p.getKupac().getPrezimeKupca();
            case 2: return sdf.format(p.getDatumIsporuke());
            case 3: return p.getGrad();
            case 4: return p.getAdresa();
            case 5: return p.getKonacnaCena();
